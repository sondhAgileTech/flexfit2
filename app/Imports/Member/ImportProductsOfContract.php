...
class ImportProductsOfContract implements ToModel,WithStartRow,WithHeadingRow
{
    ...
    */
    public function model(array $row)
    {
        ...
        $product = Product::firstOrCreate([
            ...
            'provider' => trim($row['don_vi_cung_cap']),
        ...
        if($contract) {
            ...
            'product_id' => $data->id,
            'guarantee_one' => Carbon::parse($contract->finish_date)->addMonth(3),
            'guarantee_two' => Carbon::parse($contract->finish_date)->addMonth(6),
            'guarantee_three' => Carbon::parse($contract->finish_date)->addMonth(12),
            ]);
        }
