...
Route::get('/api/download/{id_contract}','ContractClient@getPdfFile')->where('id_contract', '[A-Za-z0-9\-]+');
Route::get('/api/download_file/{id_contract}','ContractClient@getFileContract')->where('id_contract', '[A-Za-z0-9\-]+');